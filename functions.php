...
function my_theme_add_scripts() {
    if (is_page('dealers')) {
        wp_enqueue_script( 'google-map', 'https://maps.googleapis.com/maps/api/js?key="AIzaSyAOR69R3VuzqQimyoXl8SepRMQn87h9K2M', array(), '3', true );
...
function my_acf_google_map_api( $api ){
    $api['key'] = 'AIzaSyAOR69R3VuzqQimyoXl8SepRMQn87h9K2M';
    return $api;
}
